...
def transform_features(features):
    ...
    return pd.concat([Blowfish_features, rsa_features], ignore_index=True)

def svm_classifier_Blowfish_vs_RSA(features):
    ...
    print(f"Accuracy of Blowfish vs RSA classifier: {accuracy * 100:.2f}%")
    ...
    model_path = os.path.join(MODELS_DIR, "svm_classifier_Blowfish_v_RSA_optimized.joblib")
    dump(svm, model_path)
...
def main():
    ...
    svm_classifier_Blowfish_vs_RSA(transformed_features)
