...
def transform_features(features):
    ...
    return pd.concat([aes_features, des_features], ignore_index=True)


def svm_classifier_AES_vs_DES(features):
    ...
    print(f"Accuracy of AES vs DES classifier: {accuracy * 100:.2f}%")
    ...
    model_path = os.path.join(MODELS_DIR, "svm_classifier_AES_v_DES_optimized.joblib")
    dump(svm, model_path)
...
def main():
    ...
    svm_classifier_AES_vs_DES(transformed_features)
